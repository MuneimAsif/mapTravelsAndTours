...
import { 
  Globe, Plane, Building2, Palmtree, Heart, Compass, Users, MapPin, 
  Calendar, ArrowRight, Check, Sparkles, Send
} from "lucide-react";
...
const travelTypes = [
  ...
  { name: "Adventure Tour", icon: Compass },
  { name: "Beach Getaway", icon: Palmtree },
  { name: "Business Travel", icon: Building2 },
  { name: "City Break", icon: Globe },
];
...
const CustomizePage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Our travel expert will contact you within 24 hours to plan your perfect trip.",
    });
          ...
          <div className="container-custom">
            ...
            >
              ...
              <h1 className="font-serif text-4xl lg:text-5xl font-bold text-foreground mb-6">
                Build Your Perfect
                <span className="text-primary block mt-2">Travel Package</span>
              </h1>
              <p className="text-lg text-muted-foreground">
                Tell us your dream destination and travel style — our experts will craft a personalized itinerary just for you.
              </p>
            </motion.div>
