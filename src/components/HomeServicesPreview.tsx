...
import { Globe, Plane, Building2, FileText, ArrowRight } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Link } from "react-router-dom";

const services = [
  { icon: Globe, title: "International Tours", description: "Curated holiday packages to 100+ worldwide destinations." },
  { icon: Plane, title: "Flight Booking", description: "Premium flights with major airlines at best prices." },
  { icon: Building2, title: "Hotel Accommodation", description: "From budget-friendly to 5-star luxury properties." },
  { icon: FileText, title: "Visa Processing", description: "Fast and hassle-free visa services for all destinations." },
];
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {services.map((service, index) => (
            <motion.div
              ...
              className="card-premium hover:border-gold/30 border border-transparent group"
            >
